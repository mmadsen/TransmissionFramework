...
package org.madsenlab.sim.tf.models.WrightFisherUnitIntervalDriftModel;
...
public class WrightFisherUnitIntervalDriftModel extends AbstractSimModel {
    ...
    public WrightFisherUnitIntervalDriftModel() {
        this.modelNamePrefix = "WrightFisherUnitIntervalDrift";
    }
    ...
    public void initializeModel() {
        ...
        if (isInfiniteAlleles == Boolean.TRUE) {
            traitFactory = new InfiniteAllelesUnitIntervalTraitFactory(this);
        } else {
            log.error("NEED IMPLEMENTATION FOR NON INFINITE ALLELES TRAIT FACTORY!!!");
            System.exit(1);
        }
        this.dimension = new UnstructuredTraitDimension<Double>(this, traitFactory);
