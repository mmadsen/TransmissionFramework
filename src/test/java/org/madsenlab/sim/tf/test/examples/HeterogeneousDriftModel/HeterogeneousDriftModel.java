...
package org.madsenlab.sim.tf.test.examples.HeterogeneousDriftModel;
...
public class HeterogeneousDriftModel extends AbstractSimModel {
    ...
    public HeterogeneousDriftModel() {
        this.modelNamePrefix = "ConformistDrift";
    }
    ...
    public void initializeModel() {
        ...
        //
        // First in the stack is deciding whether to copy or mutate.  This rule has two sub rules:
        // one of the mutation rule objects, and a stack of copying rules.
        //
        // Second, the copying rule is made up of a decision rule, which decides between conformism
        // and random copying with some probability
        //
        this.ruleList = new ArrayList<IActionRule>();

        IInteractionRule decisionRule = new CopyOrMutateDecisionRule(this);

        // construct the stack of copying decision rules and action subrules
        IInteractionRule conformismDecisionRule = new ConformismOrRandomDecisionRule(this);
        ...
        IInteractionRule cmfRule = new CopyConformistTraitNeighborRule(this);
        cmfRule.setTraitCopyingMode(TraitCopyingMode.PREVIOUS);
        conformismDecisionRule.registerSubRule(rcmRule);
        conformismDecisionRule.registerSubRule(cmfRule);
        ...
        // now add the conformism decision stack to the top level copy-or-mutate stack
        decisionRule.registerSubRule(conformismDecisionRule);

        // Just add the decision rule, since it has all the subrules
