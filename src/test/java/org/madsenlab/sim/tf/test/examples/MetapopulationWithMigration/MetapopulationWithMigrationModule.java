...
import org.madsenlab.sim.tf.structure.WellMixedWithinDemeTopologyProvider;
 ...
 */
public class MetapopulationWithMigrationModule implements Module {
    public void configure(Binder binder) {
        binder.bind(ISimulationModel.class)
                .to(MetapopulationWithMigrationModel.class)
                .in(Singleton.class);
        ...
        binder.bind(IInteractionTopology.class).toProvider(WellMixedWithinDemeTopologyProvider.class);
