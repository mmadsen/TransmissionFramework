...
import org.madsenlab.sim.tf.agent.DimensionalTraitAgentProvider;
 ...
 */
public class MultiDimensionWrightFisherDriftModule implements Module {
    public void configure(Binder binder) {
        binder.bind(ISimulationModel.class)
                .to(MultiDimensionWrightFisherDriftModel.class)
                .in(Singleton.class);
        binder.bind(IAgent.class)
                .toProvider(DimensionalTraitAgentProvider.class);
